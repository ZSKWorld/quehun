(function (exports, Laya) {
    ...
    class TiledMap {
        ...
        createMap(mapName, viewRect, completeHandler, viewRectPadding = null, gridSize = null, enableLinear = true, limitRange = false) {
            ...
            Laya.ILaya.loader.fetch(mapName, "json").then(content => this.onJsonComplete(content));
        }
        onJsonComplete(tJsonData) {
            ...
            if (this._tileSetArray.length > 0) {
                ...
                Laya.ILaya.loader.load(tPath).then(tex => this.onTextureComplete(tex));
            }
        }
        ...
        onTextureComplete(tTexture) {
            ...
            if (!this._enableLinear)
                tTexture.bitmap.filterMode = Laya.FilterMode.Point;
...
//# sourceMappingURL=laya.tiledmap_discarded.js.map
