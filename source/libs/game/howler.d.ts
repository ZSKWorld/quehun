...
declare type HowlErrorCallback = (soundId: number, error: unknown) => void;
declare type SpatialOrientation = [number, number, number];
declare type SpatialPosition = [number, number, number];

declare interface SoundSpriteDefinitions {
	[name: string]: [number, number] | [number, number, boolean];
}

declare interface PannerAttributes {
...
declare interface HowlOptions extends HowlListeners, PannerAttributes {
	/**
