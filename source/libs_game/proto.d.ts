...
declare const enum ERequest {
	 ...
	 */
	changeAvatar = ".lq.Lobby.changeAvatar",
	/**
	 * * 领取更新礼包
	 * * req: {@link IReqCommon}, res: {@link IResCommon}
	 */
	receiveVersionReward = ".lq.Lobby.receiveVersionReward",
	/**
	 * * 请求账号统计信息
	 * * req: {@link IReqAccountStatisticInfo}, res: {@link IResAccountStatisticInfo}
	 */
	fetchAccountStatisticInfo = ".lq.Lobby.fetchAccountStatisticInfo",
	/**
	 * * 获取试炼赛赛季排名信息
	 * * req: {@link IReqAccountInfo}, res: {@link IResAccountChallengeRankInfo}
	 */
	fetchAccountChallengeRankInfo = ".lq.Lobby.fetchAccountChallengeRankInfo",
	/**
	 * * 获取账号人物信息
	 * * req: {@link IReqCommon}, res: {@link IResAccountCharacterInfo}
	 */
	fetchAccountCharacterInfo = ".lq.Lobby.fetchAccountCharacterInfo",
	/**
	 * * 商店购买
	 * * req: {@link IReqShopPurchase}, res: {@link IResShopPurchase}
	 */
	shopPurchase = ".lq.Lobby.shopPurchase",
	/**
	 * * 获取单场牌谱记录
	 * * req: {@link IReqGameRecord}, res: {@link IResGameRecord}
	 */
	fetchGameRecord = ".lq.Lobby.fetchGameRecord",
	/**
	 * * 添加查看牌谱记录
	 * * req: {@link IReqGameRecord}, res: {@link IResCommon}
	 */
	readGameRecord = ".lq.Lobby.readGameRecord",
	/**
	 * * 获取牌谱列表
	 * * 20240820更新之前的牌谱通过这个接口获取
	 * * req: {@link IReqGameRecordList}, res: {@link IResGameRecordList}
	 */
	fetchGameRecordList = ".lq.Lobby.fetchGameRecordList",
	/**
	 * * 获取牌谱列表V2
	 ...
	 */
	fetchGameRecordListV2 = ".lq.Lobby.fetchGameRecordListV2",
	/**
	 * * 获取后续牌谱列表内容
	 ...
	 */
	inputOperation = ".lq.FastTest.inputOperation",
	/**
	 * * 输入吃碰胡
	 * * req: {@link IReqChiPengGang}, res: {@link IResCommon}
	 */
	inputChiPengGang = ".lq.FastTest.inputChiPengGang",
	/**
	 * * 确认新的回合
	 * * req: {@link IReqCommon}, res: {@link IResCommon}
	 */
	confirmNewRound = ".lq.FastTest.confirmNewRound",
	/**
	 * * 玩家游戏内广播
	 * * req: {@link IReqBroadcastInGame}, res: {@link IResCommon}
	 */
	broadcastInGame = ".lq.FastTest.broadcastInGame",
	/**
	 * * 玩家游戏内Gm指令
	 * * deprecated
	 * * req: {@link IReqGMCommandInGaming}, res: {@link IResCommon}
	 */
	inputGameGMCommand = ".lq.FastTest.inputGameGMCommand",
	/**
	 * * 获取对局玩家状态
