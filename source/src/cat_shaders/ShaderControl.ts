...
import { ModelLoader } from "../libs/ModelLoader";
import { MaterialFactoryAnimation } from "../shaders/animation/MaterialFactoryAnimation";
import { MaterialFactoryBasicRiver } from "../shaders/basic_river/MaterialFactoryBasicRiver";
import { MaterialFactoryBasicSea } from "../shaders/basic_sea/MaterialFactoryBasicSea";
import { MaterialFactoryBasicWater } from "../shaders/basic_water/MaterialFactoryBasicWater";
import MaterialFactoryBlur from "../shaders/blur/MaterialFactoryBlur";
import { MaterialFactoryBoatWave } from "../shaders/boatmove/MaterialFactoryBoatWave";
import { MaterialFactoryCatShadow } from "../shaders/cat_shadow/MaterialFactoryCatShadow";
import { MaterialFactoryCharacter } from "../shaders/character/MaterialFactoryCharacter";
import { MaterialFactoryCloud } from "../shaders/cloud/MaterialFactoryCloud";
import { MaterialFactoryCloud2 } from "../shaders/cloud2/MaterialFactoryCloud2";
import { MaterialFactoryCloudEarth } from "../shaders/cloud_earth/MaterialFactoryCloudEarth";
import { MaterialFactoryCloudop } from "../shaders/cloud_op/MaterialFactoryCloudop";
import { MaterialFactoryCollection } from "../shaders/collection/MaterialFactoryCollection";
import { MaterialFactoryColor } from "../shaders/color/MaterialFactoryColor";
import { MaterialFactoryDif } from "../shaders/dif/MaterialFactoryDif";
import { MaterialFactoryDifA } from "../shaders/dif_a/MaterialFactoryDifA";
import { MaterialFactoryDifCollection } from "../shaders/dif_collection/MaterialFactoryDifCollection";
import { MaterialFactoryDifEarth } from "../shaders/dif_earth/MaterialFactoryDifEarth";
import { MaterialFactoryDifEarthGlow } from "../shaders/dif_earth_glow/MaterialFactoryDifEarthGlow";
import { MaterialFactoryDiffish } from "../shaders/dif_fish/MaterialFactoryDiffish";
import { MaterialFactoryDifGlass } from "../shaders/dif_glass/MaterialFactoryDifGlass";
import { MaterialFactoryDifGround } from "../shaders/dif_ground/MaterialFactoryDifGround";
import { MaterialFactoryDifLight } from "../shaders/dif_light/MaterialFactoryDifLight";
import { MaterialFactoryDifMove } from "../shaders/dif_move/MaterialFactoryDifMove";
import { MaterialFactoryDifNolight } from "../shaders/dif_nolight/MaterialFactoryDifNolight";
import { MaterialFactoryDifNolightA } from "../shaders/dif_nolight_A/MaterialFactoryDifNolightA";
import { MaterialFactoryDifOpdoor } from "../shaders/dif_Opdoor/MaterialFactoryDifOpdoor";
import { MaterialFactoryDifReflection } from "../shaders/dif_reflection/MaterialFactoryDifReflection";
import { MaterialFactoryDifShadows } from "../shaders/dif_shadows/MaterialFactoryDifShadows";
import { MaterialFactoryEarthSea } from "../shaders/earthsea/MaterialFactoryEarthSea";
import { MaterialFactoryFishShadow } from "../shaders/fish_shadow/MaterialFactoryFishShadow";
import { MaterialFactoryFlag } from "../shaders/flag/MaterialFactoryFlag";
import { MaterialFactoryFog } from "../shaders/fog/MaterialFactoryFog";
import { MaterialFactoryFxFlash } from "../shaders/fx_flash/MaterialFactoryFxFlash";
import { MaterialFactoryIslandBasic } from "../shaders/island_basic/MaterialFactoryIslandBasic";
import { MaterialFactoryIslandLeaf } from "../shaders/island_leaf/MaterialFactoryIslandLeaf";
import { MaterialFactoryIslandRiver } from "../shaders/island_river/MaterialFactoryIslandRiver";
import { MaterialFactoryIslandSea } from "../shaders/island_sea/MaterialFactoryIslandSea";
import { MaterialFactoryIslandWaterfall } from "../shaders/island_waterfall/MaterialFactoryIslandWaterfall";
import { MaterialFactoryLightWave } from "../shaders/lightwave/MaterialFactoryLightWave";
import { MaterialFactoryMoltenSalt } from "../shaders/molten_salt/MaterialFactoryMoltenSalt";
import { MaterialFactoryOpSea } from "../shaders/opSea/MaterialFactoryOpSea";
import ShaderTool from "../shaders/ShaderTool/ShaderTool.glsl";
import { MaterialFactoryShadow } from "../shaders/shadow/MaterialFactoryShadow";
import { MaterialFactorySky } from "../shaders/sky/MaterialFactorySky";
import { MaterialFactorySunLight } from "../shaders/sun_light/MaterialFactorySunLight";
import { MaterialFactoryUishader } from "../shaders/ui_shader/MaterialFactoryUishader";
import { MaterialFactoryUishaderlight } from "../shaders/ui_shader_light/MaterialFactoryUishaderlight";
import { MaterialFactoryUvMove } from "../shaders/uv_move/MaterialFactoryUvMove";
import { MaterialFactoryWave } from "../shaders/wave/MaterialFactoryWave";
import MaterialFactoryWaveWarp from "../shaders/WaveWarp/MaterialFactoryWaveWarp";
...
export class ShaderControl {
    private static _inst: ShaderControl;

    public static get inst(): ShaderControl {
        (!this._inst) && (this._inst = new ShaderControl());
        return this._inst;
    }
