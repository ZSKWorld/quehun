...
import vs from "./BasicWater.vs";
import fs from "./BasicWater.fs";
...
export class MaterialBasicWater extends Laya.UnlitMaterial {
    constructor() {
        super();
        this.setShaderName("BasicWater");
...
export class ShaderBasicWater {
    public static initShader(): void {
        ...
        const shader = Laya.Shader3D.add("BasicWater", true);
