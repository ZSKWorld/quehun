...
import fs from "./CatRoom.fs";
import vs from "./CatRoom.vs";
...
export class MaterialCatRoom extends Laya.UnlitMaterial {
    constructor() {
        super();
        this.setShaderName("CatRoom");
    }
...
export class ShaderCatRoom {
    public static initShader(): void {
        ...
        const shader = Laya.Shader3D.add("CatRoom", true);
