...
import fs from "./Cloud.fs";
import vs from "./Cloud.vs";
...
export class MaterialCloud extends Laya.UnlitMaterial {
    constructor() {
        super();
        this.setShaderName("Cloud");
    ...
    public cloneTo(destObject: any) {
        ...
        destMaterial.AlphaController = this._AhplaController;
        destMaterial.TexScale = this._TexScale;
        destMaterial.CloudController = this.CloudController;
        destMaterial.Fresnelrange = this.Fresnelrange;
        destMaterial.ScaleController = this.ScaleController;
        this.CloudMove.cloneTo(destMaterial.CloudMove);
        destMaterial.blend = this.blend;
        destMaterial.blendSrc = this.blendSrc;
        destMaterial.blendDst = this.blendDst;
        destMaterial.cull = this.cull;
    }
}

export class ShaderCloud {
    public static initShader(): void {
        ...
        const shader = Laya.Shader3D.add("Cloud", true);
