...
import fs from "./CloudEarth.fs";
import vs from "./CloudEarth.vs";
...
export class MaterialCloudEarth extends Laya.UnlitMaterial {
    constructor() {
        super();
        this.setShaderName("CloudEarth");
    ...
    public clone() {
        const dest = new MaterialCloudEarth();
        this.cloneTo(dest);
        return dest;
    }
...
export class ShaderCloudEarth {
    public static initShader(): void {
        ...
        const shader = Laya.Shader3D.add("CloudEarth");
