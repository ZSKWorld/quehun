...
import fs from "./Cloudop.fs";
import vs from "./Cloudop.vs";
...
const _Fresnelrange = Laya.Shader3D.propertyNameToID("_Fresnelrange");
...
export class MaterialCloudop extends Laya.UnlitMaterial {
    constructor() {
        super();
        this.setShaderName("Cloudop");
    ...
    public get _Fresnelrange(): number {
        return this._shaderValues.getNumber(_Fresnelrange);
    }

    public set _Fresnelrange(v: number) {
        this._shaderValues.setNumber(_Fresnelrange, v);
    }
    ...
    public get _CloudMove(): Laya.Vector4 {
    ...
    public clone() {
        const dest = new MaterialCloudop();
        this.cloneTo(dest);
        return dest;
    }
    ...
    public cloneTo(destObject: any) {
        ...
        destMaterial._Fresnelrange = this._Fresnelrange;
...
export class ShaderCloudop {
    public static initShader(): void {
        ...
        const uniformMap = {
            ...
            _Fresnelrange: Laya.Shader3D.PERIOD_MATERIAL,
        ...
        const shader = Laya.Shader3D.add("Cloudop");
