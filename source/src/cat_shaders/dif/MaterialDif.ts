...
export class MaterialDif extends Laya.UnlitMaterial {
    ...
    public get Saturation() {
        return this._shaderValues.getNumber(Saturation);
    }
    ...
    public get LightRange() {
        return this._shaderValues.getNumber(LightRange);
    }
    ...
    public get SpRange() {
        return this._shaderValues.getNumber(SpRange);
    }
