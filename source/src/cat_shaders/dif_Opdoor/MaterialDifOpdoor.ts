...
import fs from "./DifOpdoor.fs";
import vs from "./DifOpdoor.vs";
...
const _RimColorController = Laya.Shader3D.propertyNameToID("_RimColorController");
const _RimColorRange = Laya.Shader3D.propertyNameToID("_RimColorRange");
const _RimColor = Laya.Shader3D.propertyNameToID("_RimColor");

export class MaterialDifOpdoor extends Laya.UnlitMaterial {
    constructor() {
        super();
        this.setShaderName("DifOpdoor");
    ...
    public get _RimColorController(): number {
        return this._shaderValues.getNumber(_RimColorController);
    }

    public set _RimColorController(v: number) {
        this._shaderValues.setNumber(_RimColorController, v);
    }

    public get _RimColorRange(): number {
        return this._shaderValues.getNumber(_RimColorRange);
    }

    public set _RimColorRange(v: number) {
        this._shaderValues.setNumber(_RimColorRange, v);
    }

    public get _RimColor() {
        return this._shaderValues.getVector(_RimColor);
    }

    public set _RimColor(v: Laya.Vector4) {
        this._shaderValues.setVector(_RimColor, v);
    }

    public clone() {
        const dest = new MaterialDifOpdoor();
        this.cloneTo(dest);
        return dest;
    }
    ...
    public cloneTo(destObject: any) {
        ...
        destMaterial._RimColorController = this._RimColorController;
        destMaterial._RimColorRange = this._RimColorRange;
        destMaterial._RimColor = this._RimColor;
    }
}

export class ShaderDifOpdoor {
    public static initShader(): void {
        ...
        const uniformMap = {
            ...
            _RimColorController: Laya.Shader3D.PERIOD_MATERIAL,
            _RimColorRange: Laya.Shader3D.PERIOD_MATERIAL,
            _RimColor: Laya.Shader3D.PERIOD_MATERIAL,
        ...
        const shader = Laya.Shader3D.add("DifOpdoor");
