...
import fs from "./DifEarth.fs";
import vs from "./DifEarth.vs";
...
export class MaterialDifEarth extends Laya.UnlitMaterial {
    constructor() {
        super();
        this.setShaderName("DifEarth");
    ...
    public clone() {
        const dest = new MaterialDifEarth();
        this.cloneTo(dest);
        return dest;
    }
...
export class ShaderDifEarth {
    public static initShader(): void {
        ...
        const shader = Laya.Shader3D.add("DifEarth");
