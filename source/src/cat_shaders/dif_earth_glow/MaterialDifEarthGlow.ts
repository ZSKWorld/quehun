...
import fs from "./DifEarthGlow.fs";
import vs from "./DifEarthGlow.vs";
import fs1 from "./DifEarthGlow1.fs";
import vs1 from "./DifEarthGlow1.vs";
...
const _SpeculaCrolor = Laya.Shader3D.propertyNameToID("_SpeculaCrolor");
const _Gloss = Laya.Shader3D.propertyNameToID("_Gloss");
...
export class MaterialDifEarthGlow extends Laya.UnlitMaterial {
    constructor() {
        super();
        this.setShaderName("DifEarthGlow");
    ...
    public get _SpeculaCrolor() {
        return this._shaderValues.getVector(_SpeculaCrolor);
    }

    public set _SpeculaCrolor(v: Laya.Vector4) {
        this._shaderValues.setVector(_SpeculaCrolor, v);
    }

    public get _Gloss(): number {
        return this._shaderValues.getNumber(_Gloss);
    }

    public set _Gloss(v: number) {
        this._shaderValues.setNumber(_Gloss, v);
    }
    ...
    public clone() {
        const dest = new MaterialDifEarthGlow();
        this.cloneTo(dest);
        return dest;
    }
    ...
    public cloneTo(destObject: any) {
        ...
        destMaterial._SpeculaCrolor = this._SpeculaCrolor;
        destMaterial._Gloss = this._Gloss;
...
export class ShaderDifEarthGlow {
    public static initShader(): void {
        ...
        const uniformMap = {
            ...
            _SpeculaCrolor: Laya.Shader3D.PERIOD_MATERIAL,
            _Gloss: Laya.Shader3D.PERIOD_MATERIAL,
        ...
        const shader = Laya.Shader3D.add("DifEarthGlow");
