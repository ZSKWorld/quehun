...
import vs from "./IslandBasic.vs";
import fs from "./IslandBasic.fs";
...
export class MaterialIslandBasic extends Laya.UnlitMaterial {
    constructor() {
        super();
        this.setShaderName("IslandBasic");
    }
...
export class ShaderIslandBasic {
    public static initShader(): void {
        ...
        const shader = Laya.Shader3D.add("IslandBasic", true);
