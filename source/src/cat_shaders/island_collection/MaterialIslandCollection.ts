...
import vs from "./IslandCollection.vs";
import fs from "./IslandCollection.fs";
...
export class MaterialIslandCollection extends Laya.UnlitMaterial {
    constructor() {
        super();
        this.setShaderName("IslandCollection");
    }
...
export class ShaderIslandCollection {
    public static initShader(): void {
        ...
        const shader = Laya.Shader3D.add("IslandCollection", true);
