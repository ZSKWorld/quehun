...
import fs from "./IslandRiver.fs";
import vs from "./IslandRiver.vs";
...
export class MaterialIslandRiver extends Laya.UnlitMaterial {
    constructor() {
        super();
        this.setShaderName("IslandRiver");
...
export class ShaderIslandRiver {
    public static initShader(): void {
        ...
        const shader = Laya.Shader3D.add("IslandRiver", true);
