...
void main() {
...
#ifdef TILINGOFFSET
    v_uv0=a_Texcoord0;
    v_uv1=TransformUV1(a_Texcoord0,u_TilingOffset);
#else
    v_uv0=a_Texcoord0;
    v_uv1=a_Texcoord0;
#endif
    ...
    //vec3 vertexAni = (vec3(0.6,0.3254902,0.1098039)*sin((((worldPos.r-objPos.r)+(worldPos.b-objPos.b))+(u_Time*u_frequency)))*u_intencity);
