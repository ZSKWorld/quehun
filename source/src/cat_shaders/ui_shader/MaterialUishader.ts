...
import fs from "./Uishader.fs";
import vs from "./Uishader.vs";
...
export class MaterialUishader extends Laya.UnlitMaterial {
    constructor() {
        super();
        this.setShaderName("Uishader");
    ...
    public clone() {
        const dest = new MaterialUishader();
        this.cloneTo(dest);
        return dest;
    }
...
export class ShaderUishader {
    public static initShader(): void {
        ...
        const shader = Laya.Shader3D.add("Uishader");
