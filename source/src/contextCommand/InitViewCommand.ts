...
import PkgAchievementBinder from "../core/ui/ui/PkgAchievement/PkgAchievementBinder";
...
import { BtnSevenDayView } from "../core/ui/view/PkgMain/view/btns/BtnSevenDayView";
...
import { UIAchievementDetailMediator } from "../core/ui/view/PkgAchievement/mediator/uis/UIAchievementDetailMediator";
...
export class InitViewCommand extends Command {
	override execute(notifyName: string, data?: any) {
		...
		register(EViewID.BtnSevenDayView, EViewType.Button, BtnSevenDayView);
		...
		register(EViewID.ComAchieveRecentView, EViewType.Component, ComAchieveRecentView);
		register(EViewID.ComAchieveStatView, EViewType.Component, ComAchieveStatView);
		...
		register(EViewID.UIAchievementDetailView, EViewType.UI, UIAchievementDetailView, UIAchievementDetailMediator);
