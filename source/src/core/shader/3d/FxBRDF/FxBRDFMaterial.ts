...
export class FxBRDFMaterial extends Laya.Material {
	...
	static init() {
		FxBRDFMaterial.DEF_MainTex = Laya.Shader3D.getDefineByName("DEF_MainTex");
		FxBRDFMaterial.DEF_DissolveTex = Laya.Shader3D.getDefineByName("DEF_DissolveTex");
		FxBRDFMaterial.DEF_DistortionTex = Laya.Shader3D.getDefineByName("DEF_DistortionTex");
		FxBRDFMaterial.DEF_AMBlightTex = Laya.Shader3D.getDefineByName("DEF_AMBlightTex");
		FxBRDFMaterial.DEF_MaskTex = Laya.Shader3D.getDefineByName("DEF_MaskTex");
		...
		const shader = Laya.Shader3D.add(FxBRDFMaterial.ShaderName);
	...
	constructor() {
		super();
		this.setShaderName(FxBRDFMaterial.ShaderName);
	}
	...
	set u_MainTex(value) {
		this.setDefine(FxBRDFMaterial.DEF_MainTex, !!value);
	...
	set u_DissolveTex(value) {
		this.setDefine(FxBRDFMaterial.DEF_DissolveTex, !!value);
	...
	set u_DistortionTex(value) {
		this.setDefine(FxBRDFMaterial.DEF_DistortionTex, !!value);
	...
	set u_AMBlightTex(value) {
		this.setDefine(FxBRDFMaterial.DEF_AMBlightTex, !!value);
	...
	set u_MaskTex(value) {
		this.setDefine(FxBRDFMaterial.DEF_MaskTex, !!value);
