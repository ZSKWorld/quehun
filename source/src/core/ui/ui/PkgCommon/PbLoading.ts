...
export default class PbLoading extends fgui.GProgressBar {

	public img_block: fgui.GImage;
	public trans_t0: fgui.Transition;
	public static url: string = "ui://vx9zwserieavob8c";

	public static createInstance(): PbLoading {
		return <PbLoading>(fgui.UIPackage.createObject("PkgCommon", "PbLoading"));
	}
