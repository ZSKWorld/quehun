...
export default class UIItemDetail extends fgui.GComponent {
	...
	protected ctrl_goto: fgui.Controller;
	...
	protected btn_goto_2: fgui.GButton;
	...
	protected override onConstruct(): void {
		...
		this.ctrl_goto = this.getControllerAt(2);
		...
		this.btn_goto_2 = <fgui.GButton>(this.getChildAt(8));
