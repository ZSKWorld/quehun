...
export default class ComLiaoSheDecorate extends fgui.GComponent {
	...
	protected btn_use: fgui.GButton;
	...
	protected override onConstruct(): void {
		...
		this.btn_using = <fgui.GButton>(this.getChildAt(4));
		this.btn_use = <fgui.GButton>(this.getChildAt(5));
		this.btn_save = <fgui.GButton>(this.getChildAt(6));
		this.btn_preview = <fgui.GButton>(this.getChildAt(7));
		this.btn_random = <BtnSwitch1View>(this.getChildAt(8));
		this.txt_viewName = <fgui.GTextField>(this.getChildAt(10));
		this.txt_title = <fgui.GTextField>(this.getChildAt(11));
		this.list_tab = <fgui.GList>(this.getChildAt(12));
		this.list_view = <fgui.GList>(this.getChildAt(13));
		this.list_item = <fgui.GList>(this.getChildAt(14));
		this.btn_closePreview = <fgui.GButton>(this.getChildAt(16));
	}
}