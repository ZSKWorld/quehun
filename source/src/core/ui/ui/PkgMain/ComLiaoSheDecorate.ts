...
export default class ComLiaoSheDecorate extends GComponentView {
	...
	protected override onConstruct(): void {
		this.btn_editName = <fgui.GButton>(this.getChildAt(2));
		this.btn_using = <fgui.GButton>(this.getChildAt(3));
		this.btn_use = <fgui.GButton>(this.getChildAt(4));
		this.btn_save = <fgui.GButton>(this.getChildAt(5));
