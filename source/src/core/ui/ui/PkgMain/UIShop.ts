...
export default class UIShop extends fgui.GComponent {
	...
	protected override onConstruct(): void {
		...
		this.btn_zhwRefresh = <BtnShopRefreshView>(this.getChildAt(14));
		this.txt_zhwRefreshTime = <fgui.GTextField>(this.getChildAt(15));
		this.txt_zhwRefreshCount = <fgui.GTextField>(this.getChildAt(16));
		this.txt_zhwRefreshAll = <fgui.GTextField>(this.getChildAt(17));
		this.loader_currency = <fgui.GLoader>(this.getChildAt(19));
		this.txt_currencyCount = <fgui.GTextField>(this.getChildAt(20));
		this.txt_tip = <fgui.GTextField>(this.getChildAt(21));
		this.txt_refreshTime = <fgui.GTextField>(this.getChildAt(22));
		this.list_item = <fgui.GList>(this.getChildAt(24));
		this.list_skin = <fgui.GList>(this.getChildAt(25));
		this.list_cg = <fgui.GList>(this.getChildAt(26));
		this.txt_cgSellAll = <fgui.GTextField>(this.getChildAt(27));
		this.txt_cgRefreshTime = <fgui.GTextField>(this.getChildAt(28));
