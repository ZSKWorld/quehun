...
export class ComBattleConfirmView extends ExtensionClass<IView, ComBattleConfirm>(ComBattleConfirm) implements IView {

	override onCreate() {
		const { btn_buyFood, btn_buyTimes, btn_saoDang, btn_battle } = this;
		btn_buyFood.onClick(this, this.sendEvent, [ComBattleConfirmMsg.OnBtnBuyFoodClick]);
		btn_buyTimes.onClick(this, this.sendEvent, [ComBattleConfirmMsg.OnBtnBuyTimesClick]);
		btn_saoDang.onClick(this, this.sendEvent, [ComBattleConfirmMsg.OnBtnSaoDangClick]);
		btn_battle.onClick(this, this.sendEvent, [ComBattleConfirmMsg.OnBtnBattleClick]);
	}
