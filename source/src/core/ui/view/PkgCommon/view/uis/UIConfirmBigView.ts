...
export class UIConfirmBigView extends UIConfirmBig {
	...
	override onCreate() {
		...
		btn_close.onClick(this, this.event, [EUIConfirmBigMsg.OnBtnCloseClick]);
		btn_confirm.onClick(this, this.event, [EUIConfirmBigMsg.OnBtnConfirmClick]);
		btn_cancel.onClick(this, this.event, [EUIConfirmBigMsg.OnBtnCancelClick]);
	}
